...
namespace IBM.WatsonDeveloperCloud.Discovery.v1
{
    public interface IDiscoveryService
    {
        ...
        QueryResponse Query(string environmentId, string collectionId, string filter = null, string query = null, string naturalLanguageQuery = null, bool? passages = null, string aggregation = null, int? count = null, List<string> _return = null, int? offset = null, string sort = null, bool? highlight = null);
        ...
        QueryNoticesResponse QueryNotices(string environmentId, string collectionId, string filter = null, string query = null, string naturalLanguageQuery = null, bool? passages = null, string aggregation = null, int? count = null, List<string> _return = null, int? offset = null, string sort = null, bool? highlight = null);
        /// <summary>
