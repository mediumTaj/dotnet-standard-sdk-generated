...
namespace IBM.WatsonDeveloperCloud.Discovery.v1.Model
{
    ...
    public class LanguageEnrichmentOptions
    {
        ...
        /// </summary>
        /// <value>A comma sepeated list of analyses that should be applied when using the `alchemy_language` enrichment. See the the service documentation for details on each extract option.  Possible values include:    * entity   * keyword   * taxonomy   * concept   * relation   * doc-sentiment   * doc-emotion   * typed-rels.</value>
