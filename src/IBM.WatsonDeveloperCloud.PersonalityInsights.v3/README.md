...
- API version: 3.1.7
- SDK version: 
- Build date: 2017-06-09T20:03:39.931Z
...
------------ | ------------- | ------------- | -------------
*PersonalityinsightsAPI* | [**Profile**](PersonalityinsightsAPI.md#profile) | **PostAsync** /v3/profile | Generates a personality profile based on input text.
